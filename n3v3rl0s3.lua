...
for i,v in next, game.CoreGui:GetChildren() do
    if v:IsA("ScreenGui") and v.Name == "ViceXLib" then
        v:Destroy() 
    end
end
...
local userlines = Instance.new("Frame")

Frame.Parent = Body
Frame.BackgroundColor3 = Color3.fromRGB(22, 23, 27)
Frame.BackgroundTransparency = 1.00
Frame.Position = UDim2.new(0.0121580549, 0, 0.869536877, 0)
...
PlayerImage.Position = UDim2.new(-0.00417404063, 0, 0.17909807, 0)
PlayerImage.Size = UDim2.new(0, 50, 0, 50)

CircleCorner.CornerRadius = UDim.new(2, 0)
CircleCorner.Name = "CircleCorner"
CircleCorner.Parent = PlayerImage

PlayerName.Name = "PlayerName"
PlayerName.Parent = Frame
PlayerName.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
PlayerName.BackgroundTransparency = 1.010
PlayerName.Position = UDim2.new(0.240065679, 0, -0.0104143433, 0)
PlayerName.Size = UDim2.new(0, 112, 0, 56)
...
statusnm.BackgroundColor3 = Color3.fromRGB(13, 57, 84)
statusnm.BackgroundTransparency = 1.010
statusnm.Position = UDim2.new(0.173399001, 0, 0.495351732, 0)
statusnm.Size = UDim2.new(0, 124, 0, 32)
statusnm.Font = Enum.Font.GothamBlack
statusnm.Text = "Free User"
statusnm.TextColor3 = Color3.fromRGB(9, 208, 211)
statusnm.TextSize = 14.000

-- Scripts:

local function OSVX_fake_script() -- Frame.Image 
...
coroutine.wrap(OSVX_fake_script)()


userlines.Name = "userlines"
userlines.Parent = Body
userlines.BackgroundColor3 = Color3.fromRGB(15, 23, 36)
userlines.BorderSizePixel = 0
userlines.Position = UDim2.new(-0.00151975686, 2, 0.868124068, 0)
userlines.Size = UDim2.new(0, 186, 0, 3)
